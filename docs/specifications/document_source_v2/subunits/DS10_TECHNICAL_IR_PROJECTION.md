...
Projeter une ir technique traçable sans interprétation éditoriale.

## Entrées obligatoires

`NativeDocument + profil + catalogues styles, relations, métadonnées, annotations et ressources`
...
- styles et métadonnées projetés comme faits techniques protégés ;
- aucune application implicite de style inventée ;
